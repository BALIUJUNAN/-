...
// ==================== 全局变量 ====================
static TransferOrder *g_transfer_orders = NULL;
static TransferItem *g_transfer_items = NULL;
...
// ==================== 全局变量 ====================
static SupplierFinance *g_supplier_finances = NULL;
static Payable *g_payables = NULL;
static PaymentRecord *g_payment_records = NULL;
